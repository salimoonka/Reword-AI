...
- Имена собственные, числа, даты, аббревиатуры и ссылки оставь без изменений.`,
  ...
  correction: `Исправь только ошибки в тексте — орфографию, пунктуацию и грамматику. Больше НИЧЕГО не меняй.
Правила:
- Исправь орфографические ошибки (опечатки, неправильные буквы, слитное/раздельное написание).
- Исправь пунктуацию (пропущенные/лишние запятые, точки, тире, кавычки).
- Исправь грамматические ошибки (согласование, падежи, времена глаголов, числительные).
- НЕ перефразируй, НЕ меняй слова на синонимы, НЕ перестраивай предложения.
- НЕ меняй стиль, тон или регистр речи.
- Сохраняй регистр (заглавные/строчные) букв оригинала: если слово написано со строчной буквы в середине предложения — оставь строчной. Заглавная буква уместна ТОЛЬКО в начале предложения, в именах собственных и аббревиатурах.
- Сохраняй все форматирование (абзацы, переносы, списки).
